...
import { Download, Mail, Phone, MapPin, Linkedin, ExternalLink, Award, Sparkles, Briefcase, GraduationCap, Target, Car, Camera, Waves, Footprints, Clock } from 'lucide-react';
  ...
  return (
    <section id="resume" className="py-20 bg-gradient-to-b from-white to-slate-50">
      <div className="container mx-auto px-6">
        ...
        {/* The Resume Layout - A4 Format Preview */}
        <MotionDiv
          id="cv-print-area"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="resume-container max-w-[210mm] mx-auto bg-white shadow-[0_25px_60px_-15px_rgba(0,0,0,0.3)] ring-1 ring-slate-200 rounded-2xl overflow-hidden flex flex-col md:flex-row print:shadow-none print:ring-0 print:rounded-none print:max-w-none print:w-[210mm] print:h-[297mm] print:overflow-hidden"
        >
          
          {/* SIDEBAR (32%) */}
          <aside className="resume-sidebar w-full md:w-[32%] bg-slate-900 text-white p-4 md:p-5 print:w-[32%] print:p-4">
            {/* QR Code Section */}
          ...
          {/* MAIN CONTENT (68%) */}
          <main className="resume-main w-full md:w-[68%] p-4 md:p-5 overflow-hidden print:w-[68%] print:p-4">
